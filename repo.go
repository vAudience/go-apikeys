...
// func (r *RedisRepository) GetAPIKeyInfo(apiKey string, apiKeyHash string) (*APIKeyInfo, error) {
// 	var err error
// 	if apiKeyHash == "" {
...
// func (r *RedisRepository) DeleteAPIKeyInfo(apiKey string, apiKeyHash string, logger LogAdapter) (int64, error) {
// 	var err error
// 	if apiKeyHash == "" {
// 		apiKeyHash, _, err = GenerateAPIKeyHash(apiKey)
// 		if err != nil {
...
// 	}
// 	key := assembleRedisKey(REDIS_KEYCOMPONENT_JSONENTITY, apiKeyHash)
// 	logger("DEBUG", fmt.Sprintf("Deleting API key information: (%s)", key))
...
// func (r *RedisRepository) SetAPIKeyInfo(apiKeyInfo *APIKeyInfo, onlyUpdate bool) error {
...
// 		err = r.SetAPIKeyInfo(apiKeyInfo, false)
// 		if err != nil {
// 			return err
// 		}
// 	}
